...
@Component({
  standalone: true,
  imports: [FormsModule,RouterModule,NgClass,NgIf,NgForOf],
...
export class MenuItemComponent implements OnInit, OnDestroy{
    ...
    constructor(public layoutService: UserLayoutService, private cd: ChangeDetectorRef, public router: Router, private menuService: UserMenuService) {
